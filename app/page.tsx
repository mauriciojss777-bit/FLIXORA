...
export default function Home() {
  ...
  // Estados para MonetizaciÃ³n con Adsterra
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-zinc-200">
      ...
      {/* MODAL DE REPRODUCCIÃ“N + MONETIZACIÃ“N ADSTERRA */}
      {selectedVideo && (
              ...
              {!adWatched ? (
                <div className="absolute inset-0 z-10 bg-zinc-950/95 flex flex-col justify-center items-center text-white p-6 text-center">
                  ...
                  <p className="text-sm text-zinc-400 mb-6">
                    Haz clic abajo para iniciar la reproducciÃ³n limpia del video.
                  </p>
                  <button
                    onClick={() => {
      ...
      {showAdminModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <form onSubmit={handleSaveVideo} className="bg-zinc-950 border border-zinc-800 p-6 rounded-3xl max-w-md w-full space-y-3">
            ...
            <input type="text" placeholder="TÃ­tulo" value={title} onChange={e => setTitle(e.target.value)} className="w-full bg-zinc-900 border border-zinc-800 p-3 rounded-xl text-white outline-none" />
