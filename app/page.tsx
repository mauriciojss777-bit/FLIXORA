...
return (
<HorizontalVideoCard 0} isSaved="{isSaved}" key="{video.id}" likesCount="{likesMap[video.id]" onSelect="{handleSelectVideo}" onToggleSave="{toggleWatchLater}" video="{video}" ||/>
);
})}
</div>
)}
...
<a 
href="[https://paypal.me/TU_USUARIO_PAYPAL](https://paypal.me/TU_USUARIO_PAYPAL)" 
target="_blank" 
