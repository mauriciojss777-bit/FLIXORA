...
return (
<HorizontalVideoCard !="=" (video.views 0)} 0} : ? isSaved="{isSaved}" key="{video.id}" likesCount="{likesMap[video.id]" onOpenProfile="{handleOpenProfile}" onSelect="{handleSelectVideo}" onToggleSave="{toggleWatchLater}" undefined video="{video}" viewsCount="{viewsMap[video.id]" viewsMap[video.id] ||/>
);
})}
</div>
)}
